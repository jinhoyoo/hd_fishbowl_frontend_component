...
// ================================================================================================
// - project
const FishbowlProjectList 		= React.lazy(() => import('pages/fishbowl/Projects/List'));
const FishbowlProfile 			= React.lazy(() => import('pages/fishbowl/Profile'));
const FishbowlProjectDetail 	= React.lazy(() => import('pages/fishbowl/Projects/Detail/'));
const FishbowlProjectGannt 		= React.lazy(() => import('pages/fishbowl/Projects/Gantt'));
const FishbowlProjectForm 		= React.lazy(() => import('pages/fishbowl/Projects/ProjectForm'));
// - file
const FishbowlFileManager 		= React.lazy(() => import('pages/fishbowl/FileManager'));

// - task
const FishbowlTaskList 			= React.lazy(() => import('pages/fishbowl/Tasks/List/'));
const FishbowlTaskDetails 		= React.lazy(() => import('pages/fishbowl/Tasks/Details'));
const FishbowlKanban 			= React.lazy(() => import('pages/fishbowl/Tasks/Board/'));
const FishbowlTimeline 			= React.lazy(() => import('pages/fishbowl/Timeline/Timeline'));
					...
					children : [
						{
                            ...
                            children: [
                                {
                                    path: 'list',
                                    element: <LoadComponent component={FishbowlProjectList} />,
                                },
								{
                                    path: 'profile',
                                    element: <LoadComponent component={FishbowlProfile} />,
                                },								
                                {
                                    path: 'details',
                                    element: <LoadComponent component={FishbowlProjectDetail} />,
                                },
                                {
                                    path: 'gantt',
                                    element: <LoadComponent component={FishbowlProjectGannt} />,
                                },
                                {
                                    path: 'new',
                                    element: <LoadComponent component={FishbowlProjectForm} />,
                                },
								{
                                    path: 'evidences',
                                    element: <LoadComponent component={FishbowlFileManager} />,
                                },
                            ],
                        },
						{
                            ...
                            children: [
                                {
                                    path: 'list',
                                    element: <LoadComponent component={FishbowlTaskList} />,
                                },
                                {
                                    path: 'details',
                                    element: <LoadComponent component={FishbowlTaskDetails} />,
                                },
                                {
                                    path: 'kanban',
                                    element: <LoadComponent component={FishbowlKanban} />,
                                },     
								{
                                    path: 'be',
                                    element: <LoadComponent component={FishbowlTimeline} />,
                                },                        
                            ],
                        },
					],
